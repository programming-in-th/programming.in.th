      ...
      >
        <div className="space-y-1 px-10 font-light text-gray-400 dark:text-gray-200">
          ...
          {group.run_result.map(result => (
            <div className="flex w-full space-x-2" key={result.test_index}>
              <p className="w-[2rem] min-w-[2rem] text-base font-light">
                {result.test_index}
              </p>
              <p className="w-[6rem] min-w-[4.5rem] text-sm font-light">
                <span className="text-base font-medium text-gray-500 dark:text-white">{`${Math.floor(
                  result.time_usage * 1000
                )} `}</span>
                ms
              </p>
              <p className="w-[6rem] min-w-[5rem] text-sm font-light">
                <span className="text-base font-medium text-gray-500 dark:text-white">{`${result.memory_usage} `}</span>
                kB
              </p>
