...
export const loadTasks = (min_difficulty: number, max_difficulty: number, tags: Array<String>) => {
	return async (dispatch: ThunkDispatch<{}, {}, AnyAction>): Promise<void> => {
		try {
			let url = "https://us-central1-grader-ef0b5.cloudfunctions.net/getAllTasksWithFilter?limit=10";
			if(min_difficulty !== -1) {
