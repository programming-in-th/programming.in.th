          ...
          <div className="bg-white px-4 py-2 dark:bg-slate-800 sm:rounded-lg sm:px-10">
            <div className="mt-6">
              <div className="mt-6 flex flex-col gap-6">
                <div>
                  <button
                    className="inline-flex w-full justify-center gap-3 rounded-md bg-white px-4 py-4 text-sm font-medium text-gray-500 shadow-md transition hover:bg-gray-50 dark:bg-slate-600 dark:text-white dark:hover:bg-slate-700"
